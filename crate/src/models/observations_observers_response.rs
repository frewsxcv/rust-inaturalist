...
pub struct ObservationsObserversResponse {
...
impl ObservationsObserversResponse {
    pub fn new(results: Vec<crate::models::ObservationsObserversResponseAllOfResults>) -> ObservationsObserversResponse {
