...
pub struct PostObservationPhoto {
    #[serde(rename = "observation_photo", skip_serializing_if = "Option::is_none")]
    pub observation_photo: Option<Box<crate::models::PostObservationPhotoObservationPhoto>>,
}

impl PostObservationPhoto {
    pub fn new() -> PostObservationPhoto {
