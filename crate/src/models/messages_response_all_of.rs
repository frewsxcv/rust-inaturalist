...
pub struct MessagesResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::Message>,
}

impl MessagesResponseAllOf {
    pub fn new(results: Vec<crate::models::Message>) -> MessagesResponseAllOf {
        MessagesResponseAllOf { results }
    }
}
