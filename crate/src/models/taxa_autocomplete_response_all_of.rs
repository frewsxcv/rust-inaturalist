...
pub struct TaxaAutocompleteResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::AutocompleteTaxon>,
}

impl TaxaAutocompleteResponseAllOf {
    pub fn new(results: Vec<crate::models::AutocompleteTaxon>) -> TaxaAutocompleteResponseAllOf {
        TaxaAutocompleteResponseAllOf { results }
    }
}
