...
pub struct UpdateProjectObservationProjectObservation {
    #[serde(rename = "project_id", skip_serializing_if = "Option::is_none")]
    pub project_id: Option<i32>,
    #[serde(rename = "observation_id", skip_serializing_if = "Option::is_none")]
    pub observation_id: Option<i32>,
    #[serde(rename = "prefers_curator_coordinate_access", skip_serializing_if = "Option::is_none")]
    pub prefers_curator_coordinate_access: Option<bool>,
}

impl UpdateProjectObservationProjectObservation {
    pub fn new() -> UpdateProjectObservationProjectObservation {
        UpdateProjectObservationProjectObservation {
            project_id: None,
            observation_id: None,
            prefers_curator_coordinate_access: None,
        }
    }
}
