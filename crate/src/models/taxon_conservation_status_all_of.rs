...
pub struct TaxonConservationStatusAllOf {
    #[serde(rename = "place", skip_serializing_if = "Option::is_none")]
    pub place: Option<Box<crate::models::CorePlace>>,
}

impl TaxonConservationStatusAllOf {
    pub fn new() -> TaxonConservationStatusAllOf {
        TaxonConservationStatusAllOf { place: None }
    }
}
