...
pub struct PostUserUpdateSession {
    #[serde(rename = "preferred_taxon_page_ancestors_shown", skip_serializing_if = "Option::is_none")]
    pub preferred_taxon_page_ancestors_shown: Option<bool>,
    #[serde(rename = "preferred_taxon_page_place_id", skip_serializing_if = "Option::is_none")]
    pub preferred_taxon_page_place_id: Option<i32>,
    #[serde(rename = "preferred_taxon_page_tab", skip_serializing_if = "Option::is_none")]
    pub preferred_taxon_page_tab: Option<String>,
    #[serde(rename = "prefers_skip_coarer_id_modal", skip_serializing_if = "Option::is_none")]
    pub prefers_skip_coarer_id_modal: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_annotations", skip_serializing_if = "Option::is_none")]
    pub prefers_hide_obs_show_annotations: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_projects", skip_serializing_if = "Option::is_none")]
    pub prefers_hide_obs_show_projects: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_tags", skip_serializing_if = "Option::is_none")]
    pub prefers_hide_obs_show_tags: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_observation_fields", skip_serializing_if = "Option::is_none")]
    pub prefers_hide_obs_show_observation_fields: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_identifiers", skip_serializing_if = "Option::is_none")]
    pub prefers_hide_obs_show_identifiers: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_copyright", skip_serializing_if = "Option::is_none")]
    pub prefers_hide_obs_show_copyright: Option<bool>,
    #[serde(rename = "prefers_hide_obs_show_quality_metrics", skip_serializing_if = "Option::is_none")]
