...
pub struct ProjectMembersResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::ProjectMember>,
}

impl ProjectMembersResponseAllOf {
    pub fn new(results: Vec<crate::models::ProjectMember>) -> ProjectMembersResponseAllOf {
        ProjectMembersResponseAllOf { results }
    }
}
