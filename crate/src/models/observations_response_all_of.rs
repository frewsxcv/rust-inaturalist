...
pub struct ObservationsResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::Observation>,
}

impl ObservationsResponseAllOf {
    pub fn new(results: Vec<crate::models::Observation>) -> ObservationsResponseAllOf {
        ObservationsResponseAllOf { results }
    }
}
