...
pub struct UpdateProjectObservation {
    #[serde(rename = "project_observation", skip_serializing_if = "Option::is_none")]
    pub project_observation: Option<Box<crate::models::UpdateProjectObservationProjectObservation>>,
}

impl UpdateProjectObservation {
    pub fn new() -> UpdateProjectObservation {
