...
pub struct SpeciesCountsResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::SpeciesCountsResponseAllOfResults>,
}

impl SpeciesCountsResponseAllOf {
    pub fn new(results: Vec<crate::models::SpeciesCountsResponseAllOfResults>) -> SpeciesCountsResponseAllOf {
