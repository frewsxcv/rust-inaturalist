...
pub struct PlacesResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::ShowPlace>,
}

impl PlacesResponseAllOf {
    pub fn new(results: Vec<crate::models::ShowPlace>) -> PlacesResponseAllOf {
        PlacesResponseAllOf { results }
    }
}
