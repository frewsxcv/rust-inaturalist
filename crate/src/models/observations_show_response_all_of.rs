...
pub struct ObservationsShowResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::ShowObservation>,
}

impl ObservationsShowResponseAllOf {
    pub fn new(results: Vec<crate::models::ShowObservation>) -> ObservationsShowResponseAllOf {
        ObservationsShowResponseAllOf { results }
    }
}
