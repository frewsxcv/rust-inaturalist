...
pub struct ObservationsObserversResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::ObservationsObserversResponseAllOfResults>,
}

impl ObservationsObserversResponseAllOf {
    pub fn new(results: Vec<crate::models::ObservationsObserversResponseAllOfResults>) -> ObservationsObserversResponseAllOf {
