...
pub struct Message {
    ...
    pub to_user: Option<Box<crate::models::User>>,
    #[serde(rename = "from_user", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "thread_messages_count", skip_serializing_if = "Option::is_none")]
    pub thread_messages_count: Option<i32>,
    /// Array of flags on messages in this thread. Only included when threads=true 
    #[serde(rename = "thread_flags", skip_serializing_if = "Option::is_none")]
    pub thread_flags: Option<Vec<serde_json::Value>>,
}
