...
pub struct SpeciesCountsResponseAllOfResults {
    #[serde(rename = "count", skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
    #[serde(rename = "taxon", skip_serializing_if = "Option::is_none")]
    pub taxon: Option<Box<crate::models::ShowTaxon>>,
}

impl SpeciesCountsResponseAllOfResults {
    pub fn new() -> SpeciesCountsResponseAllOfResults {
