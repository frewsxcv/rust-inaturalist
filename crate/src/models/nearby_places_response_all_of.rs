...
pub struct NearbyPlacesResponseAllOf {
    #[serde(rename = "results")]
    pub results: Box<crate::models::NearbyPlacesResponseAllOfResults>,
}

impl NearbyPlacesResponseAllOf {
    pub fn new(results: crate::models::NearbyPlacesResponseAllOfResults) -> NearbyPlacesResponseAllOf {
