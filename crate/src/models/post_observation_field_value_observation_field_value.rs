...
pub struct PostObservationFieldValueObservationFieldValue {
    #[serde(rename = "observation_id", skip_serializing_if = "Option::is_none")]
    pub observation_id: Option<i32>,
    #[serde(rename = "observation_field_id", skip_serializing_if = "Option::is_none")]
    pub observation_field_id: Option<i32>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}

impl PostObservationFieldValueObservationFieldValue {
    pub fn new() -> PostObservationFieldValueObservationFieldValue {
