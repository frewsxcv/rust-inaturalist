...
pub struct NearbyPlacesResponseAllOfResults {
    #[serde(rename = "standard", skip_serializing_if = "Option::is_none")]
    pub standard: Option<Vec<crate::models::ShowPlace>>,
    #[serde(rename = "community", skip_serializing_if = "Option::is_none")]
    pub community: Option<Vec<crate::models::ShowPlace>>,
}

impl NearbyPlacesResponseAllOfResults {
    pub fn new() -> NearbyPlacesResponseAllOfResults {
