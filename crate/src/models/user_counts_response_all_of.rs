...
pub struct UserCountsResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::UserCountsResponseAllOfResults>,
}

impl UserCountsResponseAllOf {
    pub fn new(results: Vec<crate::models::UserCountsResponseAllOfResults>) -> UserCountsResponseAllOf {
