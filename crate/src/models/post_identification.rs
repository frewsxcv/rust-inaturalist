...
pub struct PostIdentification {
    #[serde(rename = "identification", skip_serializing_if = "Option::is_none")]
    pub identification: Option<Box<crate::models::PostIdentificationIdentification>>,
}

impl PostIdentification {
    pub fn new() -> PostIdentification {
        PostIdentification {
            identification: None,
        }
    }
