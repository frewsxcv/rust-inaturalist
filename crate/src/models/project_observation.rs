...
pub struct ProjectObservation {
    ...
    #[serde(
        rename = "curator_identification_id",
        skip_serializing_if = "Option::is_none"
    )]
    pub curator_identification_id: Option<i32>,
    #[serde(rename = "tracking_code", skip_serializing_if = "Option::is_none")]
    pub tracking_code: Option<String>,
    #[serde(
        rename = "prefers_curator_coordinate_access",
        skip_serializing_if = "Option::is_none"
    )]
...
impl ProjectObservation {
    pub fn new() -> ProjectObservation {
        ProjectObservation {
            id: None,
            project_id: None,
            observation_id: None,
            curator_identification_id: None,
            tracking_code: None,
