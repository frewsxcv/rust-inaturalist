...
pub struct TaxaShowResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::ShowTaxon>,
}

impl TaxaShowResponseAllOf {
    pub fn new(results: Vec<crate::models::ShowTaxon>) -> TaxaShowResponseAllOf {
        TaxaShowResponseAllOf { results }
    }
}
