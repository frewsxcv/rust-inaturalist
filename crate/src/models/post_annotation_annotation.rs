...
pub struct PostAnnotationAnnotation {
    ...
    #[serde(rename = "controlled_attribute_id", skip_serializing_if = "Option::is_none")]
    pub controlled_attribute_id: Option<i32>,
    #[serde(rename = "controlled_value_id", skip_serializing_if = "Option::is_none")]
    pub controlled_value_id: Option<i32>,
}

impl PostAnnotationAnnotation {
    pub fn new() -> PostAnnotationAnnotation {
        PostAnnotationAnnotation {
            resource_type: None,
            resource_id: None,
            controlled_attribute_id: None,
            controlled_value_id: None,
        }
    }
}
