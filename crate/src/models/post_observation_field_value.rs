...
pub struct PostObservationFieldValue {
    #[serde(rename = "observation_field_value", skip_serializing_if = "Option::is_none")]
    pub observation_field_value: Option<Box<crate::models::PostObservationFieldValueObservationFieldValue>>,
}

impl PostObservationFieldValue {
    pub fn new() -> PostObservationFieldValue {
        PostObservationFieldValue {
            observation_field_value: None,
        }
    }
}
