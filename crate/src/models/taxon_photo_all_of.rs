...
pub struct TaxonPhotoAllOf {
    #[serde(rename = "medium_url", skip_serializing_if = "Option::is_none")]
    pub medium_url: Option<String>,
    #[serde(rename = "square_url", skip_serializing_if = "Option::is_none")]
    pub square_url: Option<String>,
}

impl TaxonPhotoAllOf {
    pub fn new() -> TaxonPhotoAllOf {
        TaxonPhotoAllOf {
            medium_url: None,
            square_url: None,
        }
