...
pub struct ShowTaxon {
    ...
    #[serde(rename = "preferred_common_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "conservation_status", skip_serializing_if = "Option::is_none")]
    pub conservation_status: Option<Box<crate::models::ConservationStatus>>,
    #[serde(rename = "conservation_statuses", skip_serializing_if = "Option::is_none")]
    pub conservation_statuses: Option<Vec<crate::models::TaxonConservationStatus>>,
    ...
    #[serde(rename = "preferred_establishment_means", skip_serializing_if = "Option::is_none")]
    pub preferred_establishment_means: Option<String>,
}

impl ShowTaxon {
    pub fn new() -> ShowTaxon {
        ShowTaxon {
            id: None,
