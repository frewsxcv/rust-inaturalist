...
pub struct ShowTaxon {
    ...
    pub conservation_status: Option<Box<models::ConservationStatus>>,
    #[serde(
        rename = "conservation_statuses",
        skip_serializing_if = "Option::is_none"
    )]
    pub conservation_statuses: Option<Vec<models::TaxonConservationStatus>>,
    #[serde(rename = "default_photo", skip_serializing_if = "Option::is_none")]
    pub default_photo: Option<Box<models::TaxonPhoto>>,
    #[serde(
        rename = "establishment_means",
        skip_serializing_if = "Option::is_none"
    )]
    pub establishment_means: Option<Box<models::EstablishmentMeans>>,
    #[serde(rename = "observations_count", skip_serializing_if = "Option::is_none")]
    pub observations_count: Option<i32>,
    #[serde(
        rename = "preferred_establishment_means",
        skip_serializing_if = "Option::is_none"
    )]
