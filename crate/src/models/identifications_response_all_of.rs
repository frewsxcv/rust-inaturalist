...
pub struct IdentificationsResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::Identification>,
}

impl IdentificationsResponseAllOf {
    pub fn new(results: Vec<crate::models::Identification>) -> IdentificationsResponseAllOf {
        IdentificationsResponseAllOf { results }
    }
}
