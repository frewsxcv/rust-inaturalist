...
pub struct ProjectsResponseAllOf {
    #[serde(rename = "results")]
    pub results: Vec<crate::models::Project>,
}

impl ProjectsResponseAllOf {
    pub fn new(results: Vec<crate::models::Project>) -> ProjectsResponseAllOf {
        ProjectsResponseAllOf { results }
    }
}
