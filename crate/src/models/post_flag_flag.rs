...
pub struct PostFlagFlag {
    #[serde(rename = "flaggable_type", skip_serializing_if = "Option::is_none")]
    pub flaggable_type: Option<FlaggableType>,
    #[serde(rename = "flaggable_id", skip_serializing_if = "Option::is_none")]
    pub flaggable_id: Option<i32>,
    #[serde(rename = "flag", skip_serializing_if = "Option::is_none")]
    pub flag: Option<serde_json::Value>,
}

impl PostFlagFlag {
    pub fn new() -> PostFlagFlag {
        PostFlagFlag {
            flaggable_type: None,
            flaggable_id: None,
            flag: None,
...
impl Default for FlaggableType {
    fn default() -> FlaggableType {
        Self::Comment
    }
}
