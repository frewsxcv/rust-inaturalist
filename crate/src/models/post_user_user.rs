...
pub struct PostUserUser {
    ...
    /// Locale code for language/region localization. See https://github.com/inaturalist/inaturalist/tree/master/config/locales for available locales. Valid strings can be derived from file names, e.g. `es-MX` from `es-MX.yml`. 
    #[serde(rename = "locale", skip_serializing_if = "Option::is_none")]
    pub locale: Option<String>,
    /// Default time zone for the user's observations. See http://api.rubyonrails.org/classes/ActiveSupport/TimeZone.html for a list of values. 
    #[serde(rename = "time_zone", skip_serializing_if = "Option::is_none")]
    pub time_zone: Option<String>,
    /// ID of the place for this user, customizes some common names and default search parameters 
