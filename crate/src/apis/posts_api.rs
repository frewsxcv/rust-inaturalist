...
pub async fn posts_for_user_get(
    ...
    if let Some(ref local_var_str) = newer_than {
        local_var_req_builder =
            local_var_req_builder.query(&[("newer_than", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = older_than {
        local_var_req_builder =
            local_var_req_builder.query(&[("older_than", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsForUserGetError> =
...
pub async fn posts_get(
    ...
    if let Some(ref local_var_str) = login {
        local_var_req_builder =
            local_var_req_builder.query(&[("login", &local_var_str.to_string())]);
    }
...
pub async fn posts_id_delete(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsIdDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn posts_id_put(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsIdPutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn posts_post(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
