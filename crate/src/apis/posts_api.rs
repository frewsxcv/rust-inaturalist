...
pub async fn posts_for_user_get(configuration: &configuration::Configuration, params: PostsForUserGetParams) -> Result<(), Error<PostsForUserGetError>> {
    ...
    let local_var_uri_str = format!("{}/posts/for_user", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = newer_than {
        local_var_req_builder = local_var_req_builder.query(&[("newer_than", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = older_than {
        local_var_req_builder = local_var_req_builder.query(&[("older_than", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsForUserGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn posts_get(configuration: &configuration::Configuration, params: PostsGetParams) -> Result<(), Error<PostsGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn posts_id_delete(configuration: &configuration::Configuration, params: PostsIdDeleteParams) -> Result<(), Error<PostsIdDeleteError>> {
    ...
    let local_var_uri_str = format!("{}/posts/{id}", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsIdDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn posts_id_put(configuration: &configuration::Configuration, params: PostsIdPutParams) -> Result<(), Error<PostsIdPutError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsIdPutError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn posts_post(configuration: &configuration::Configuration, params: PostsPostParams) -> Result<(), Error<PostsPostError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostsPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
