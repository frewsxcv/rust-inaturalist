...
pub struct AnnotationsPostParams {
    /// Annotation object
    pub body: Option<models::PostAnnotation>,
}
...
pub struct VotesVoteAnnotationIdPostParams {
    ...
    pub id: String,
    /// Vote object
    pub body: Option<models::PostVote>,
}
...
pub async fn annotations_id_delete(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<AnnotationsIdDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn annotations_post(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AnnotationsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn votes_unvote_annotation_id_delete(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VotesUnvoteAnnotationIdDeleteError> =
...
pub async fn votes_vote_annotation_id_post(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VotesVoteAnnotationIdPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
