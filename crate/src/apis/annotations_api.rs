...
pub async fn annotations_id_delete(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<AnnotationsIdDeleteError>> {
    ...
    let local_var_uri_str = format!("{}/annotations/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AnnotationsIdDeleteError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn annotations_post(configuration: &configuration::Configuration, body: Option<crate::models::PostAnnotation>) -> Result<(), Error<AnnotationsPostError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AnnotationsPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn votes_unvote_annotation_id_delete(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<VotesUnvoteAnnotationIdDeleteError>> {
    ...
    let local_var_uri_str = format!("{}/votes/unvote/annotation/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VotesUnvoteAnnotationIdDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn votes_vote_annotation_id_post(configuration: &configuration::Configuration, id: &str, body: Option<crate::models::PostVote>) -> Result<(), Error<VotesVoteAnnotationIdPostError>> {
    ...
    let local_var_uri_str = format!("{}/votes/vote/annotation/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VotesVoteAnnotationIdPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
