...
pub async fn colored_heatmap_zoom_xy_png_get(configuration: &configuration::Configuration, params: ColoredHeatmapZoomXyPngGetParams) -> Result<(), Error<ColoredHeatmapZoomXyPngGetError>> {
...
/// Given zero to many of following parameters, returns a PNG image representing the matching observations within a map tile, following the XYZ tiling scheme 
pub async fn grid_zoom_xy_png_get(configuration: &configuration::Configuration, params: GridZoomXyPngGetParams) -> Result<(), Error<GridZoomXyPngGetError>> {
    let local_var_configuration = configuration;
...
/// Given zero to many of following parameters, returns a PNG image representing the matching observations within a map tile, following the XYZ tiling scheme 
pub async fn heatmap_zoom_xy_png_get(configuration: &configuration::Configuration, params: HeatmapZoomXyPngGetParams) -> Result<(), Error<HeatmapZoomXyPngGetError>> {
    let local_var_configuration = configuration;
...
/// Given zero to many of following parameters, returns a PNG image representing the matching observations within a map tile, following the XYZ tiling scheme 
pub async fn points_zoom_xy_png_get(configuration: &configuration::Configuration, params: PointsZoomXyPngGetParams) -> Result<(), Error<PointsZoomXyPngGetError>> {
    let local_var_configuration = configuration;
