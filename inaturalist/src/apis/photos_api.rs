...
pub async fn photos_post(
    ...
    params: PhotosPostParams,
) -> Result<(), Error<PhotosPostError>> {
    let uri_str = format!("{}/photos", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<PhotosPostError> = serde_json::from_str(&content).ok();
