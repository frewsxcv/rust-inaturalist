...
pub struct ObservationsObserversResponseAllOfResults {
    #[serde(rename = "observation_count", skip_serializing_if = "Option::is_none")]
...
impl ObservationsObserversResponseAllOfResults {
    pub fn new() -> ObservationsObserversResponseAllOfResults {
