...
pub struct Annotation {
    ...
    #[serde(
        rename = "controlled_attribute_id",
        skip_serializing_if = "Option::is_none"
    )]
    pub controlled_attribute_id: Option<i32>,
    #[serde(
        rename = "controlled_value_id",
        skip_serializing_if = "Option::is_none"
    )]
    pub controlled_value_id: Option<i32>,
    #[serde(
        rename = "concatenated_attr_val",
        skip_serializing_if = "Option::is_none"
    )]
    pub concatenated_attr_val: Option<String>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<Box<models::User>>,
    #[serde(rename = "user_id", skip_serializing_if = "Option::is_none")]
    pub user_id: Option<i32>,
    #[serde(rename = "vote_score", skip_serializing_if = "Option::is_none")]
