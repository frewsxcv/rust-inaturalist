...
pub struct PostIdentificationIdentification {
    #[serde(rename = "observation_id", skip_serializing_if = "Option::is_none")]
    pub observation_id: Option<i32>,
    #[serde(rename = "taxon_id", skip_serializing_if = "Option::is_none")]
...
impl PostIdentificationIdentification {
    pub fn new() -> PostIdentificationIdentification {
