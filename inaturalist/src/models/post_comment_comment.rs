...
impl PostCommentComment {
    pub fn new() -> PostCommentComment {
        PostCommentComment {
            parent_type: None,
            parent_id: None,
            body: None,
...
pub enum ParentType {
    ...
    Observation,
    #[serde(rename = "ListedTaxon")]
    ListedTaxon,
    #[serde(rename = "AssessmentSection")]
    AssessmentSection,
    #[serde(rename = "ObservationField")]
    ObservationField,
    #[serde(rename = "Post")]
    Post,
    #[serde(rename = "TaxonChange")]
    TaxonChange,
}
